...
def eliminarUsuario(request, id):
    ...
    if(u):
        ...
        messages.success(request, 'Se ha eliminado el usuario exitosamente.')
        ...
        if(request.method == 'POST'):
            ...
            if ('nombre' in request.POST and
                ...
                try:
                    ...
                    print e
                    messages.error(
                        request, 'Ocurrio un error al crear el usuario. Verifique los campos e intente de nuevo.')

                # Se creo el usuario correctamente
                messages.success(
                    request, u'Se añadio al usuario con exito! :)')
